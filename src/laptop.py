...
class LaptopPilot:
    ...
    def infinite_loop(self):
        ...
        if (self.initialise_pose != True and
            ...
            # Update state estimate using motion model only
            ...
            if flag == True:
                ...
                if (t_em[0] < 1 and t_em[1] < 1):
                    landmark_id = 0

                elif (t_em[0] > 1 and t_em[0] < 2 ) and  (t_em[1] > 0 and t_em[1] < 1 ):
                    landmark_id = 1               

                elif (t_em[0] > 1 and t_em[0] < 2 ) and  (t_em[1] > 1 and t_em[1] < 2 ):
                    landmark_id = 2

                elif (t_em[0] > 0 and t_em[0] < 1 ) and  (t_em[1] > 1 and t_em[1] < 2 ):
                    landmark_id = 3 
